...
import { ExternalLink, TrendingUp, TrendingDown, Minus, Sparkles } from 'lucide-react'
...
export default function MarketInsights() {
  ...
  const [sellView,  setSellView] = useState('week') // 'week' | 'movement'
      ...
      {marketData.analysis && (
        <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-100 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="ml-auto text-xs text-violet-400">Generated by Claude · {marketData.month}</span>
          </div>
          <p className="text-sm text-gray-700 leading-relaxed">{marketData.analysis.digest}</p>
          {marketData.analysis.signals?.length > 0 && (
            <div className="flex gap-2 mt-3 flex-wrap">
              {marketData.analysis.signals.map((s, i) => (
